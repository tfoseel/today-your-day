...
from .views import RecipientCreateView, RollingPaperCreateView, RecipientDetailByUUIDView, recipient_invite_view, write_rollingpaper_view, recipient_rollingpapers_view
